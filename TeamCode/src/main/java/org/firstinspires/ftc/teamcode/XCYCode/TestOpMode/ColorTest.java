...
import org.firstinspires.ftc.teamcode.XCYCode.AutoSuperStructure;
...
public class ColorTest extends LinearOpMode {
   ...
   public void runOpMode() {
      ...
      AutoSuperStructure upper = new AutoSuperStructure(
              hardwareMap,
              this::opModeIsActive,
              this::idle
      );
      upper.setSideIsRed(side_red);
      waitForStart();
      while (opModeIsActive()) {
         ...
         telemetry_M.addLine(upper.getConeData());
         telemetry_M.update();
      }
   }
}
